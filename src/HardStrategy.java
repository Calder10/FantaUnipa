 ...
 *
 */
public class HardStrategy implements AstaStrategy{
	
	
	/** Metodo che permette all'utente virtuale di rilanciare di 10 rispetto alla puntata massima o eventualmente rinucniare
     * 
