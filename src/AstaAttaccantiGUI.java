...
public class AstaAttaccantiGUI extends AstaGUI {
	...
	public AstaAttaccantiGUI getAstaAttaccantiGUI() {
		return this;
	}

	public AstaAttaccantiGUI(String username1) {
		super("Asta Attaccanti");
		...
		JLabel lblNewLabel = new JLabel("Asta Attaccanti in corso.....");
		...
		searchButton1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				scrollpane1.setVisible(false);
				try {
					String ris = UtilityListaGiocatori.cercaGiocatore(searchable1.getText(), 3);
		...
		btnNewButtonShowAll1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					ris = UtilityListaGiocatori.showAllPlayers(3);
		...
		btnNewButtonChoose.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					nextFrame = new AstaGiocatoreGUI(getAstaAttaccantiGUI(), username1, lblNewLabelRis1.getText(),3);
		...
		list1.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				AstaGiocatoreGUI nextFrame;
				try {
					nextFrame = new AstaGiocatoreGUI(getAstaAttaccantiGUI(), username1, nomeGiocatore,3);
					nextFrame.setVisible(true);
					nextFrame.toFront();
					btnNewButtonChoose.setVisible(false);
					lblNewLabelRis1.setVisible(false);
